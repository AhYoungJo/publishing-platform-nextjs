...
import {githubLogin, register} from '@/server/users.action';
    ...
    <>
      <div className='min-h-[calc(100vh-210px)] max-h-[calc(100vh-210px)] flex items-center justify-center'>
        <div className='w-[375px] rounded-lg bg-white border border-[#D1D1D1] py-10 px-[25px] text-[#4f4f4f]'>
          ...
          <h1 className='text-xl font-bold mb-[10px]'> Register Into App</h1>
          ...
          <form className='grid gap-4' action={register} method='POST'>
            ...
            <div className='mt-4 grid gap-4'>
              ...
              <Button
                type='button'
                className='py-2 px-4 max-w-md flex justify-center items center bg-gray-600 hover:bg-gray-700 focus:ring-gray-600 text-center text-base font-normal hover:font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg w-full'
